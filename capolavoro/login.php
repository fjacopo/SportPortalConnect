...
<body>
    <div class="container">
        ...
        <div class="pdf-links">
    <a href="Manuale.pdf" class="pdf-link" target="_blank">
        <img src="pdf_icon.png" alt="PDF Icon" title="Manuale d'Uso">
    </a>
    <a href="Documentazione.pdf" class="pdf-link" target="_blank">
        <img src="tabelle_icon.png" alt="PDF Icon" title="Documentazione">
    </a>
</div>
</div>
